...
def meta_for_table_name(table_name):
    meta_mapping = {
        ...
        "protocolreport": "ip|group1|acct|happendate|category|protocol|uptraffic|downtraffic|during|",
        "protocolreport_today": "ip|group1|acct|happendate|category|protocol|uptraffic|downtraffic|during|",
